...
%          terme 1er ordre: [C,r] = FrickDF(50, 1, 30, 2, 1);
%
% Historique
% 02-Oct-2022 : Création
% 19-Oct-2022 : Modifications pour le devoir 2
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [C, rpos] = FickDF(Ntot, dt, Ndt, schema, tsMeth)
